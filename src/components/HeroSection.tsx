      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-950/50 border border-purple-800/50 mb-8 animate-fade-in">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-cyan-400 to-purple-400 animate-text">
              Transform Your Writing Journey
            </h1>
            
            <p className="text-xl text-gray-300 mb-8 leading-relaxed animate-fade-in opacity-0" style={{ animationDelay: '300ms' }}>
            ...
            <Button 
              ...
              className="relative group px-8 py-6 mb-8 overflow-hidden rounded-full bg-gradient-to-r from-purple-600 to-cyan-600 text-white shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:scale-105 hover:from-purple-500 hover:to-cyan-500"
            >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 animate-fade-in opacity-0" style={{ animationDelay: '600ms' }}>
              <Button 
                ...
                className="px-8 py-6 rounded-full text-lg border-purple-700/50 text-purple-300 hover:bg-purple-950/50 transition-colors duration-300"
              >
                Explore Features
              </Button>
            </div>
