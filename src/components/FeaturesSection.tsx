    ...
    <section id="features" className="py-16 md:py-24 px-4 relative overflow-hidden scroll-mt-16 bg-gradient-to-br from-slate-50 to-white">
      <div className="container mx-auto relative z-10 max-w-7xl">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400/60 to-pink-400/60">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {features.map((feature, index) => (
            <div 
              key={feature.title}
              className="group relative p-6 md:p-8 rounded-2xl bg-white/40 backdrop-blur-sm border border-gray-100 
            ...
            >
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="text-lg md:text-xl font-semibold mb-3 text-gray-900 group-hover:text-purple-600 transition-colors duration-300">
                  {feature.title}
                </h3>
